...
#set_property PACKAGE_PIN W18 [get_ports {echo}]
...
#set_property PACKAGE_PIN P3 [get_ports {motorLED[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {motorLED[0]}]
#set_property PACKAGE_PIN N3 [get_ports {motorLED[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {motorLED[1]}]
#set_property PACKAGE_PIN P1 [get_ports {motorLED[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {motorLED[2]}]
#set_property PACKAGE_PIN L1 [get_ports {motorLED[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {motorLED[3]}]
